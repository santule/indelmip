...
def main():
    ...
    write_to_file('mip_new_pattern_1.csv',new_pattern,'mip')
    ...
    write_to_file('mip_percent_ancestors_with_2_mut_1.csv',percent_ancestors_with_2_mut,'mip')
    write_to_file('mip_sites_with_3_mut_1.csv',total_sites_3_mut,'mip')
