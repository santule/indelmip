...
# main function
def score_fn(nwk_file_path,indel_fasta_solution_file,extant_alignment_file,add_start_end):
...
if __name__ == "__main__":
  out_pattern_percent = score_fn(nwk_file_path,indel_fasta_solution_file,extant_alignment_file,add_start_end)
